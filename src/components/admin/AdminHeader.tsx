  ...
  return (
    <header className="fixed top-0 w-full z-50 bg-background/95 backdrop-blur-lg border-b border-border">
      <div className="w-full px-3 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        {/* Logo */}
        <Link to="/admin-dashboard" className="flex items-center space-x-2 flex-shrink-0">
          <img 
        ...
        <div className="hidden lg:flex items-center space-x-3 xl:space-x-4">
          ...
          <Button variant="ghost" size="sm" className="text-sm relative">
            ...
            <Badge className="absolute -top-1 -right-1 h-5 w-5 bg-red-500 rounded-full text-xs text-white flex items-center justify-center">3</Badge>
          </Button>
          <div className="relative">
            <Button 
              variant="ghost" 
