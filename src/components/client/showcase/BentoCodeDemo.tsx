...
export function BentoCodeDemo() {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col p-4 sm:p-5">
      <div className="mb-3 flex shrink-0 items-center gap-2 border-b border-border pb-2 font-mono text-[10px] text-muted-foreground">
